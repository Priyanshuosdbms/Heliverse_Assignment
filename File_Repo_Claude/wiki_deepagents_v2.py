...
def validate_relates_to() -> str:
    ...
    for md_file in WIKI_ROOT.rglob("*.md"):
        ...
        try:
            ...
            problems.append(f"{md_file.relative_to(WIKI_ROOT)}: malformed frontmatter block")
            continue
    ...
    if not problems:
        return summary + " No relates_to/type problems found."
...
def validate_relates_to_tool() -> str:
    ...
    whole wiki and return a report. Use this after a batch of writes to
    check your own correlations mechanically, rather than trusting memory."""
